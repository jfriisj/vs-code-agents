...
3. **Report Findings**:
   ...
   - Include issue coverage in the comment (`ISS-*` IDs analyzed) and a reference/link to your detailed markdown artifact (`agent-output/analysis/NNN-topic-analysis.md`) in the comment.
...
4. **Mandatory Planka Exit Gate (Analyst)**:
  ...
  - Verify all analysis tasks created in this phase contain `ISS-` IDs.
