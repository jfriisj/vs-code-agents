...
> [!IMPORTANT]
> In this repository setup, run this command from `Kanban/`. The compose file mounts repository root as `/vault` (`../:/vault`) so Obsidian can use `/vault/agent-output` as the active vault.
