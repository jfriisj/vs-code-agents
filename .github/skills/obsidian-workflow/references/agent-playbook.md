...
- Workflow note frontmatter must include: `project_name: "<Project Name>"`
- Use wikilinks (`[[...]]`) for all workflow-to-workflow and workflow-to-artifact references.
...
7. If you changed frontmatter/headings/links, run `node .github/skills/obsidian-workflow/scripts/verify-obsidian-graph.mjs`.
...
- Artifact links should be Obsidian wikilinks when the artifact is inside `agent-output/`.
